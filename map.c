...
void affichagePersonnage(BITMAP * buffer,BITMAP *steve1,BITMAP *steve2, BITMAP *steve3, BITMAP* steve4, t_joueur *michel,int joueurTour) // AFFICHAGE DU JOUEUR EN FONCTION DU NB DE JOUEUR ET DU TOUR PASSER EN PARAMETRE
{
    if(michel[0].nbJoueur == 2)
    {
        if(joueurTour == 0)
        {
            ...
            draw_sprite(buffer, steve2, (michel[1].posx+10), (michel[1].posy));
        }
        else if(joueurTour == 1)
        {
            draw_sprite(buffer, steve1, (michel[0].posx+10), (michel[0].posy));
...
void animstate(BITMAP * buffer,BITMAP *steve1,BITMAP *steve2, BITMAP *steve3, BITMAP* steve4, t_joueur *michel,int joueurTour) // AFFICHAGE DU JOUEUR EN FONCTION DU NB DE JOUEUR ET DU TOUR PASSER EN PARAMETRE
{
    if(michel[0].nbJoueur == 2)
    {
        if(joueurTour == 0)
